#!/bin/bash
# insfollow v2.0
# recoded by: Vishnu kushwaha
# github.com/Vishnu1Z/Hacki
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92mVishnu Hacks"
...
printf "  \e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Made by vishnu ☀️\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
